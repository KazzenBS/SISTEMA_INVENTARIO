...
public class Contrato extends Documento {
    ...
    public Contrato(LocalDate dataCriacao, String autor, String classificacao, String partesEnvolvidas, LocalDate dataAssinatura, LocalDate dataValidade) {
    ...
    public static Contrato aquisicao() {
        ...
        return new Contrato(dataCriacao, autor, classificacao, partesEnvolvidas, dataAssinatura, dataValidade);
    }
